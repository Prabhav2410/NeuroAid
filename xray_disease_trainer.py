...
"""
X-Ray Disease Classification Model Training - OPTIMIZED FOR SPEED
...
class Config:
    ...
    MODEL_SAVE_PATH = "xray_disease_model.h5"
    CLASS_NAMES_PATH = "xray_disease_classes.json"
    HISTORY_PATH = "xray_training_history.json"
...
def evaluate_model(model, test_gen):
    ...
    print(f"✅ Test Top-2 Accuracy: {results[2]:.4f}")
    print("=" * 60 + "\n")
...
def plot_training_history(history):
    ...
    print("✅ Training history plot saved as 'xray_training_history.png'")
    plt.close()
...
def main():
    ...
    print("\n" + "=" * 60)
    print("X-RAY DISEASE CLASSIFICATION - OPTIMIZED TRAINING")
    print("=" * 60)
    ...
    print(f"📁 Class names saved to: {Config.CLASS_NAMES_PATH}")
    print(f"📁 Training history saved to: {Config.HISTORY_PATH}")
    print(f"📁 Training plot saved to: xray_training_history.png")
    print("\n🎯 Test your model:")
    print("   python xray_disease_prediction.py <image_path>")
    print("=" * 60 + "\n")
